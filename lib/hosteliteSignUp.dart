...
class HosteliteSignUp extends StatefulWidget {
  const HosteliteSignUp({super.key});

  @override
  State<HosteliteSignUp> createState() => _HosteliteSignUpState();
}

class _HosteliteSignUpState extends State<HosteliteSignUp> {
  List<int> routes = [];
  List<String> stops = [];
  String? selectedRole;
  int? selectedRoute;
